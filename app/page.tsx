        ...
        <section id="gallery" className="py-20 bg-gradient-to-br from-[#8E4585] to-[#A855A7] text-white">
          <div className="container mx-auto px-4">
            <motion.div
              ...
              style={{ willChange: "transform, opacity" }}
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-4 font-serif">Our Beautiful Journey</h2>
              <p className="text-xl text-white/80 max-w-2xl mx-auto">
                Every picture tells a story of love, laughter, and the beautiful moments we've shared together
              </p>

              {/* Decorative elements */}
              <div className="flex justify-center items-center mt-8 gap-4">
                <div className="h-px bg-white/30 w-16" />
                <Heart className="text-[#FAEEC8]" size={24} fill="currentColor" />
                <div className="h-px bg-white/30 w-16" />
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              viewport={{ once: true, amount: 0.3 }}
            >
              <p className="text-white/70 italic">Click any image to view in full size</p>
            </motion.div>
          </div>
        </section>
